...
import com.android.wallpaper.Flags.FLAG_REFACTOR_WALLPAPER_PREVIEW_SCREEN_FLAG
...
class DownloadableWallpaperRepositoryTest {
    ...
    @DisableFlags(FLAG_REFACTOR_WALLPAPER_PREVIEW_SCREEN_FLAG)
    @Test
    fun downloadableWallpaperModel_downloadSuccess() = runTest {
        ...
        assertThat(categoryWallpapersRepository.invalidateCacheFunctionCallCount).isEqualTo(0)
        assertThat(categoryWallpapersRepository.refreshWallpapersFunctionCallCount).isEqualTo(0)
    }

    @EnableFlags(FLAG_REFACTOR_WALLPAPER_PREVIEW_SCREEN_FLAG)
    @Test
    fun downloadableWallpaperModel_downloadSuccess_refreshWallpapersCalled() = runTest {
        val downloadableWallpaperModel = collectLastValue(underTest.downloadableWallpaperModel)
        ...
        assertThat(categoryWallpapersRepository.invalidateCacheFunctionCallCount).isEqualTo(1)
        assertThat(categoryWallpapersRepository.refreshWallpapersFunctionCallCount).isEqualTo(1)
    }
